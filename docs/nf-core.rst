...
Currently, there are 72 pipelines that are available as part of nf-core (41 released, 25 under development and 6 archived). 
...
.. try to run the nf-core rnaseq pipeline
